...
export class AmgixApi extends runtime.BaseAPI {
    ...
    /**
     * Get persisted collection statistics.  Returns document counts maintained by the indexing pipeline (not a live physical count).  Args:     collection_name: The name of the collection.  Returns:     A `CollectionStatsResponse` with the current `doc_count`.  Raises:     HTTPException: 404 if the collection does not exist.
