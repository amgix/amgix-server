...
class EmbedRouter(Protocol):
    ...
    async def __call__(self, vector_config: VectorConfigInternal, docs: List[str], avgdls: Optional[List[float]] = None) -> Union[List[List[float]], List[Tuple[List[int], List[float]]]]:
        pass
