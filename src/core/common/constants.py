...
MAX_METADATA_VALUE_LENGTH = 1000000  # Maximum length for metadata string values (non-indexed / JSON blob)
MAX_INDEXED_METADATA_VALUE_LENGTH = 1024  # Maximum length for indexed metadata string columns
...
MAX_DOCUMENT_FETCH_PAGE_SIZE = 1000  # Maximum page_size for document fetch
DEFAULT_DOCUMENT_FETCH_PAGE_SIZE = 100  # Default page_size for document fetch
...
WMTR_DEFAULT_TRIGRAM_WEIGHT = 1.0  # Fixed WMTR trigram multiplier for document indexing; default for VectorSearchOption.wmtr_trigram_weight
